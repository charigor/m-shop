...
//    }
    ...
    #[NoReturn] public function updatedCity($city): void
    {
        $this->warehouse = '';
        $this->getWarehouses($city);
    }
    #[NoReturn] public function updatedWarehouse($value): void
    {
        $this->warehouse = $value;
    }
    #[NoReturn] public function updatedType($value): void
    {
        $this->warehouse = '';
        $this->type = $value;
    }
    ...
    {
        $response = Cache::remember('cities', 86400, function () use($term) {
