...
class PermissionController extends Controller
{
    ...
    public function store(PermissionCreateRequest $request)
    {
        ...
        return redirect()->route('permission.edit',$permission->id)->with('message','Item(s) was created successfully');
    }
    /**
     * @return \Inertia\Response
     */
    ...
    public function update(PermissionUpdateRequest $request, Permission $permission)
    {
        ...
        return redirect()->route('permission.index')->with('message','Item(s) was updated successfully');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect()->route('permission.index')->with('message','Item(s) was deleted successfully');;
    }
}
