...
<!--                    &lt;!&ndash;                        <ResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')">&ndash;&gt;-->
...
<!--                                        &lt;!&ndash;                                    <ApplicationLogo&ndash;&gt;-->
<!--                                        &lt;!&ndash;                                        class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200"&ndash;&gt;-->
<!--                                        &lt;!&ndash;                                    />&ndash;&gt;-->
<!--                                        &lt;!&ndash;                                </Link>&ndash;&gt;-->
<!--                                    </div>-->
...
<!--                                        &lt;!&ndash;                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">&ndash;&gt;-->
<!--                                        &lt;!&ndash;                                    Dashboard&ndash;&gt;-->
<!--                                        &lt;!&ndash;                                </NavLink>&ndash;&gt;-->
