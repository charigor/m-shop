...
import {defineComponent, computed, defineProps, ref,onMounted, reactive, watchEffect, watch} from "vue";
...
const submit = () => {
    router.put(`${urlPrefix}/${props[pageName].id}`, form, {preserveState: true})
}
defineComponent({
    LayoutAuthenticated,
...
onMounted(() => {
    ...
    taxPrice.value = Number(props.product.price) + Number(props.product.price /100 * Number(stage))
})
</script>
<template>
    <LayoutAuthenticated>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="relative z-0 w-full mb-6 group required">
                                        <input v-model="form.reference" type="text"  id="reference" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent  border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                ...
                                <div class="p-3 ">
                                    ...
                                    <div class="relative w-full mb-6 group required">
                                        <input v-model="form.quantity" type="number" min="0" id="quantity_main" class="block indent-2 py-2.5 px-0 w-full z-0 text-sm text-gray-900 bg-transparent border-0 border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                        ...
                        <template v-if="activeTab === 'price'">
                            <div class="col-span-4">
                                <div class="grid grid-cols-5 gap-10">
                                        <div class="col-span-1">
                                            <div class="relative z-0 w-full mb-6 group">
                                                <input v-model="form.price" @input="inputPrice" type="text"  id="tab_price" class="mb-2 block indent-2 py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                                <p class="mt-2 text-sm text-red-600 dark:text-red-500" v-if="$page.props.errors.price">{{$page.props.errors.price}}</p>
                                            </div>
                                        </div>
                                        <div class="col-span-1">
                                          <div class="relative z-0 w-full mb-6 group">
                                            <input v-model="taxPrice" @input="inputTaxPrice" type="text"  id="tab_price_tax" class="mb-2 block indent-2 py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                         </div>
                                        </div>
                                        <div class="col-span-1">
                                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <div class="grid grid-cols-5 gap-10">
                                    ...
                                    <div class="col-span-1">
                                        <div class="relative z-0 w-full mb-6 group">
                                            <input v-model="unityPrice" @input="setRatio" type="text"  id="unit_ratio" class="mb-2 block indent-2 py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <div class="col-span-4">
                                <div v-for="language in $page.props.languages" :key="language.id">
                                    <div class="relative z-0 w-full mb-6 group" v-show="locale === language.code">
                                        <input v-model="form['lang'][language.code]['link_rewrite']"  type="text" :name="`${language.code}link_rewrite`" :id="`${language.code}meta_keywords`" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
