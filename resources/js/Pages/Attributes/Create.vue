...
<template>
    <LayoutAuthenticated>
        <SectionMain>
            <SectionTitleLineWithButton
                :icon="mdiSvg"
                :title="$t('page.attribute.title_create')"
                main
            >
            </SectionTitleLineWithButton>
